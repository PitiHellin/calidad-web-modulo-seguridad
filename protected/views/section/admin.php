...
<?php
	$gridColumns = array( 'id' , 'section' , array('class' => 'CButtonColumn' , 'template' => '{update} {delete}',) );
	$groupGridColumns = $gridColumns;
	$groupGridColumns[] = array(
		'name' => 'firstLetter',
		'value' => 'substr($data->section, 0, 1)',
	...
	$this->widget('bootstrap.widgets.TbGroupGridView', array(
		...
		'extraRowExpression' => '"<b style=\"font-size: 3em; color: #333;\">".substr($data->section, 0, 1)."</b>"',
