 ...
 * @property GeneralData[] $generalDatas
...
class Appointment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('appointment', 'required'),
			array('appointment', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, appointment', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'generalDatas' => array(self::HAS_MANY, 'GeneralData', 'appointment_id'),
			'perfils' => array(self::HAS_MANY, 'Perfil', 'appointment_id'),
		);
	}
